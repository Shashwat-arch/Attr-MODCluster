...
set ylabel "Metric Value" font "Arial,14"
...
plot 'epoch_performance.txt' using 1:2 with linespoints linestyle 1 title "ACC", \
     '' using 1:3 with linespoints linestyle 2 title "NMI", \
     '' using 1:4 with linespoints linestyle 3 title "ARI", \
     '' using 1:5 with linespoints linestyle 4 title "F1"
